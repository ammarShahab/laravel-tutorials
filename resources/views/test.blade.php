...
<body>
    ...
    <ol>
        ...
        <li>to connect the database from xampp start the MySQL and press admin which will redirect to the phpadmin page then press new and create a database with name</li>
    ...
    <p>Now follow the flowchart from 1. </p>
</body>
</html>